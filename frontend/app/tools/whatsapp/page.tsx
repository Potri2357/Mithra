  ...
  return (
    <div className={`min-h-screen flex flex-col bg-slate-100 dark:bg-[#111B21] text-slate-900 dark:text-slate-100 ${isStandalone ? "h-screen overflow-hidden" : ""}`}>
      ...
      {isStandalone ? (
        ...
        <main className="flex-1 flex flex-col items-center justify-center p-2 sm:p-4 w-full h-[calc(100vh-3.5rem)] overflow-hidden">
          <WhatsAppSimulator fullHeight />
        </main>
      ) : (
        /* Standard View: Breadcrumbs, Hero explanation, Simulator & Footer */
        <>
